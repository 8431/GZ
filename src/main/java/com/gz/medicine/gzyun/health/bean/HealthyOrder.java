...
public class HealthyOrder {
    ...
    public String toString() {
        return "HealthyOrder{" +
                ...
                ", consultingdescription='" + consultingdescription + '\'' +
                ", createdate=" + createdate +
                ", createname='" + createname + '\'' +
                ", updatename='" + updatename + '\'' +
                ", updatedate=" + updatedate +
                ", state='" + state + '\'' +
                ", reservationphotoid='" + reservationphotoid + '\'' +
                ...
                ", usrsex='" + usrsex + '\'' +
                ", usrbirth='" + usrbirth + '\'' +
                ", reserstarttime='" + reserstarttime + '\'' +
                ", reserendtime='" + reserendtime + '\'' +
                ", sendflag='" + sendflag + '\'' +
                '}';
    }
}