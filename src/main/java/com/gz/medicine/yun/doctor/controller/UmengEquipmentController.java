 ...
 */
@Controller
@RequestMapping("/umengequipments")
public class UmengEquipmentController extends ValidateWithException{
        public static final Logger LOGGER = Logger.getLogger(UmengEquipmentController.class);
        ...
        @RequestMapping(value = "/addumengequipments", method = RequestMethod.POST,produces="text/html;charset=UTF-8")
        @ResponseBody
        public SimpleResult AddUmengequipments(HealthUmengEquipmentRequest data){
